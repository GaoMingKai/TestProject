...
class Base026(unittest.TestCase):
    ...
    mqname = [
        "MySqlCrossClusterWrite","updateThirdDataRealAndHistory","ForceCalculation","mqtt-takenaka-data"
              ]
    ...
    def getCounts(self,host,mqName):
        ...
        try:
            ...
            connection = pika.BlockingConnection(pika.ConnectionParameters(host=host, credentials=credentials,socket_timeout=360))
