...
class BaseConfig:
    ...
    MYSQL_ADDR = 'rds6cde6w8oeo390pw8i.mysql.rds.aliyuncs.com'

    MYSQL_PORT = 3306

    MYSQL_USERNAME = 'beopweb2'
    ...
    #光明项目原始数据是否更新
    TEST_FOR_GUANGMING = ["rfb-notify@rnbtech.com.hk"]
    ...
    # 点计算测试集A收件人#严 顾
    CALC_TEST_EMAILS_A = ["rfb-notify@rnbtech.com.hk"]
    ...
    # 基础测试集收件人#大为,顾博
    BASE_TEST_EMAILS = ["rfb-notify@rnbtech.com.hk"]
    ...
    # message received
    MONGO_RECEIVER = ['17000060357','18601679872','18701970149', '18017764776']

    LIVERPOOL_RECEIVER = ['18520497773',]

    SQL_RECEIVER = [ '17000060357', '18701970149', '18701970149', '18017764776',"13917547764"]
